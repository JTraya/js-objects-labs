...
game.party.push(pokemon[93], pokemon[58], pokemon[132],);
console.log(game.party);
...
// console.log(pokemon.slice([3], [4]))
// game.catchPokemon = (pokemonObj) => {
//     for (let i = 0; i < pokemon.length; i++) {
//         if (pokemonObj === pokemon[i].name) {
//             pokemon.slice([pokemon[i]], [pokemon[i] + 1])
//         }
